...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO customers (customerID, FirstName, Address, PhoneNumber, Email, DateOfBirth) 
            VALUES (?, ?, ?, ?, ?, ?)";

    // Use prepared statements to prevent SQL injection
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("isssss", $customerID, $FirstName, $Address, $PhoneNumber, $Email, $DateOfBirth);
